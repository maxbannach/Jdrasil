...
vertex $u,v$ that have at least $k$ $\{$common neighbors, vertex
  disjoint paths between them$\}$. If $k-1$ is a lower bound on the
tree width of $G$, then these operations are safe with respect to tree
width~\cite{bodleanderK2011}.
