...
or alternatively
\begin{lstlisting}[language=bash]
  java -cp Jdrasil.jar jdrasil.App
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
  ...
  java -cp build/jars/Jdrasil.jar jdrasil.App
  java -cp build/classes/main jdrasil.App
\end{lstlisting}
...
an Java library):
\begin{lstlisting}[language=bash]
  java -cp build/jars/Jdrasil.jar:build/upgrades/x.jar  jdrasil.App
\end{lstlisting}
...
In \Jdrasil, the class \JClass{GraphSeperator} implements some safe
